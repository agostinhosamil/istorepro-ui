...
__n(/* Carousel */ function () {
  ...
  function getCarouselElement(query, carousel) {
  ...
  if (carouselElements.length >= 1) {
    ...
    window.addEventListener('resize', function () {
      carouselElements.forEach(function (carouselElement) {
        const carouselBody = getCarouselElement('data-carousel-body', carouselElement)
    ...
    carouselElements.forEach(function (carouselElement) {
      const carouselNextButton = getCarouselElement('data-carousel-next', carouselElement)
      const carouselPrevButton = getCarouselElement('data-carousel-prev', carouselElement)
      const carouselBody = getCarouselElement('data-carousel-body', carouselElement)
